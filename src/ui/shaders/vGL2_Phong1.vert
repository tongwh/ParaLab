...
vec4  DifColor = vec4( 0.4, 0.6, 0.8, 1.0 );
// vec4 DifColor =  vec4( 0.75164, 0.60648, 0.22648, 1.0);
vec4  SpecColor = vec4( 0.4, 0.4, 0.2, 1.0 );
// vec4  SpecColor = vec4( 0.628281, 0.555802, 0.366065, 1.0);
vec4  ULColor = vec4( 0.4, 0.3, 0.8, 1.0 );
// vec4  ULColor = vec4( 0.628281, 0.555802, 0.366065, 1.0);
